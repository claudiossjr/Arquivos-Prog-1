...
public class Jogo3 {
    ...
    void carregar(Window janela) {
        ...
        for (int i = 0; i < 15; i++) {
            bloco[i][0] = new Bloco("4.jpg");
            bloco[i][1] = new Bloco("5.jpg");
            bloco[i][2] = new Bloco("7.jpg");
            bloco[i][3] = new Bloco("5.jpg");
            bloco[i][4] = new Bloco("4.jpg");
            bloco[i][5] = new Bloco("5.jpg");
            bloco[i][6] = new Bloco("7.jpg");
            bloco[i][7] = new Bloco("5.jpg");
        }
    ...
    void inicializar() {
        ...
        for (int i = 0; i < 15; i += 2) {
            for (int j = 0; j < 8; j++) {
                bloco[i][j].x = 25 + (i * 50);
                bloco[i][j].y = 35 + bloco[i][j].height + (j * 25);
            }
        }
